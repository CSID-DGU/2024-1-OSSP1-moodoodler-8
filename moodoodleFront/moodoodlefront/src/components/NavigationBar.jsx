...
export default function NavigationBar() {
  return (
    <div className='absolute sticky bottom-0 flex flex-row w-full h-[55px] justify-center items-center z-50 bg-white shadow-componentShadow'>
      <div className='flex flex-row w-[254px] h-[38px] justify-between items-end'>
        ...
        <Link to='/mypage' className='flex flex-col items-center'>
          ...
          <p className='text-center text-[10px] font-semibold text-darkGray/90'>마이무드</p>
        </Link>
      </div>
    </div>
  );
